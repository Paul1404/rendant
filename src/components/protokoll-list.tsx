				...
				<Table>
					<TableHeader className="bg-muted/40">
						<TableRow className="hover:bg-transparent">
							<TableHead className="w-[140px] text-[11px] font-medium uppercase tracking-[0.14em] text-muted-foreground">
								Belegnummer
							</TableHead>
							<TableHead className="w-[120px] text-[11px] font-medium uppercase tracking-[0.14em] text-muted-foreground">
								Datum
							</TableHead>
							<TableHead className="text-[11px] font-medium uppercase tracking-[0.14em] text-muted-foreground">
								Anlass
							</TableHead>
							<TableHead className="w-[160px] text-right text-[11px] font-medium uppercase tracking-[0.14em] text-muted-foreground">
								Tageseinnahmen
							</TableHead>
							<TableHead className="w-[110px] text-[11px] font-medium uppercase tracking-[0.14em] text-muted-foreground">
								Status
							</TableHead>
