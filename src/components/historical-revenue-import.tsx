...
import { HistoricalProtocolFolderImport } from "@/components/historical-protocol-folder-import";
...
export function HistoricalRevenueImport() {
	...
	return (
		<>
			<HistoricalProtocolFolderImport />
			<Card className="overflow-hidden border-primary/20">
				<CardHeader>
					<CardTitle className="flex items-center gap-2.5">
						...
						Einzelne Altumsätze aus Excel
					</CardTitle>
					<CardDescription>
						Für Quellen außerhalb des Zählprotokoll-Archivs. Leere Vorlage
						herunterladen, ausfüllen und vor dem Import prüfen.
					</CardDescription>
				</CardHeader>
				<CardContent className="space-y-5">
					...
					<div className="space-y-2">
						<Label htmlFor="historical-revenue-import">
							Ausgefüllte Vorlage
						</Label>
						...
						<div className="space-y-4 rounded-xl border border-border/70 bg-muted/15 p-4">
							<div className="flex flex-wrap items-start justify-between gap-3">
								<div>
									...
									{preview.valid ? (
										<p className="mt-1 text-xs text-muted-foreground">
											Umsatz <Money cent={preview.totals.revenueCent} />,
											Ausgaben <Money cent={preview.totals.expensesCent} />
										</p>
									) : null}
								</div>
